...
void dash_create2(void)//(lv_obj_t * parent) //arc
{
    ...
    indic2 = lv_meter_add_arc(meter1, scale2, 8, lv_palette_main(LV_PALETTE_GREEN), 0);
    ...
    indic = lv_meter_add_needle_line(meter3, scale, 4, lv_palette_darken(LV_PALETTE_RED, 4), -25);
